...
Database structure design for the Huajiangjia-style image-text community project (simplified version), including core functionalities such as user management, content publishing, and social interactions.
...
| user_id | VARCHAR(50) | Huajiangjia ID | Unique identifier |
