      ...
      <div class="about-header">
        <div class="header-content">
          <div class="logo-section">
            <div class="about-logo"><img :src="logoUrl" alt="花匠家" /></div>

            <h2 class="about-title">关于花匠家</h2>
          </div>
      ...
      <div class="about-content">
        <div class="about-main">
          <div class="intro-section">
            <h3>项目简介</h3>
            <p>
              花匠家图文社区是一个面向开发者与学习者的开源示例项目，旨在提供从前端到后端的完整实践范本，帮助大家学习现代 Web 应用的架构设计、工程化与业务实现。
            </p>
          </div>
          ...
          <div class="copyright-section">
            ...
            <div class="copyright-content">
              <p>
                <strong>设计灵感：</strong>本图文社区的UI设计和交互体验参考了小红书平台，旨在为下载该开源项目的人员提供一个熟悉的项目体验。
              </p>
              <p>
          ...
          <div class="about-footer">
            <p>&copy; 2025 花匠家图文社区. Made with ❤️ by @ZTMYO</p>
          </div>
        </div>
      </div>
    </div>
...
// 静态资源URL
const logoUrl = new URL('@/assets/imgs/花匠家.png', import.meta.url).href
