    ...
    apis: [
      {
        ...
        expanded: false,
        params: [
          { name: 'user_id', type: 'string', required: true, description: '花匠家号（3-15位，字母数字下划线）' },
  ...
  "data": {
    ...
    "tokens": {
      ...
      },
      {
        ...
        expanded: false,
        params: [
          { name: 'user_display_id', type: 'string', required: true, description: '花匠家号' },
  ...
  },
  {
    ...
    apis: [
      ...
      },
      {
        ...
        path: '/api/users/:id',
        title: '获取用户详情',
        description: '根据花匠家号获取用户详细信息',
        expanded: false,
        params: [
          { name: 'id', type: 'string', required: true, description: '花匠家号' }
        ]
      },
      {
        method: 'GET',
      ...
      },
      {
        ...
        expanded: false,
        params: [
          { name: 'id', type: 'string', required: true, description: '被关注用户的花匠家号' }
        ]
      },
      {
        method: 'DELETE',
        ...
        expanded: false,
        params: [
          { name: 'id', type: 'string', required: true, description: '被取消关注用户的花匠家号' }
        ]
      },
      {
        method: 'GET',
        ...
        expanded: false,
        params: [
          { name: 'id', type: 'string', required: true, description: '目标用户的花匠家号' }
        ]
      },
      {
        method: 'GET',
    ...
    apis: [
      {
        ...
        expanded: false,
        params: [
          { name: 'keyword', type: 'string', required: false, description: '搜索关键词（支持搜索花匠家号、昵称、标题、正文内容、标签名称）' },
    ...
    "username": "admin"
      ...
      },
      {
        ...
        params: [
          ...
          { name: 'user_display_id', type: 'string', required: false, description: '按花匠家号筛选' },
      ...
      },
      {
        ...
        expanded: false,
        params: [
          { name: 'user_id', type: 'string', required: true, description: '花匠家号' },
  ...
  "message": "用户解封成功"
      ...
      },
      {
        ...
        params: [
          ...
          { name: 'user_display_id', type: 'string', required: false, description: '按作者花匠家号筛选' },
      ...
      },
      {
        ...
        params: [
          ...
          { name: 'user_display_id', type: 'string', required: true, description: '发布用户花匠家号' }
        ]
      },
      {
        method: 'PUT',
      ...
      },
      {
        ...
        params: [
          ...
          { name: 'user_display_id', type: 'string', required: false, description: '按评论者花匠家号筛选' },
      ...
      },
      {
        ...
        params: [
          ...
          { name: 'user_display_id', type: 'string', required: false, description: '用户花匠家号搜索' },
      ...
      },
      {
        ...
        params: [
          ...
          { name: 'user_display_id', type: 'string', required: false, description: '按用户花匠家号筛选' },
      ...
      },
      {
        ...
        expanded: false,
        params: [
          { name: 'user_display_id', type: 'string', required: true, description: '用户花匠家号' },
          { name: 'target_type', type: 'int', required: true, description: '目标类型（1-笔记, 2-评论）' },
          { name: 'target_id', type: 'int', required: true, description: '目标ID' }
        ]
      },
      ...
      },
      {
        ...
        params: [
          ...
          { name: 'user_display_id', type: 'string', required: false, description: '按接收用户花匠家号筛选' },
      ...
      },
      {
        ...
        expanded: false,
        params: [
          { name: 'user_display_id', type: 'string', required: true, description: '接收用户花匠家号' },
