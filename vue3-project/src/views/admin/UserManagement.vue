...
const columns = [
  ...
  { key: 'user_id', label: '花匠家号', type: 'user-link', sortable: false, maxLength: 15 },
...
const userFormFields = [
  { key: 'user_id', label: '花匠家号', type: 'text', required: true, placeholder: '请输入花匠家号', maxlength: 15 },
...
const searchFields = [
  { key: 'user_id', label: '花匠家号', placeholder: '搜索花匠家号' },
