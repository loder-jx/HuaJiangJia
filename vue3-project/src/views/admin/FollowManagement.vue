...
const columns = [
  ...
  { key: 'follower_display_id', label: '关注者花匠家号', type: 'user-link', sortable: false },
  { key: 'follower_nickname', label: '关注者昵称', sortable: false },
  { key: 'following_id', label: '被关注者ID', sortable: false },
  { key: 'following_display_id', label: '被关注者花匠家号', type: 'user-link', sortable: false },
...
const searchFields = [
  { key: 'follower_display_id', label: '关注者花匠家号', placeholder: '搜索关注者花匠家号' },
  { key: 'following_display_id', label: '被关注者花匠家号', placeholder: '搜索被关注者花匠家号' }
]
</script>