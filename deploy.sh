...
# 显示帮助信息
show_help() {
    echo -e "${CYAN}花匠家图文社区 Docker 部署脚本${NC}"
...
seed_database() {
    ...
    # 检查后端容器是否运行
    if ! docker-compose ps | grep -q "huajiangjia-backend.*Up"; then
